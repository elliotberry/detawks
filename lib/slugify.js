...
const stringModificationFunctions = {
    ...
    toParamCase: { name: 'to param case', fn: paramCase },
...
const init = () => {
    ...
    let finalFunctions = []
    slugifyConfig.forEach((fn) => {
        if (stringModificationFunctions[fn] === undefined) {
            console.warn(`Function ${fn} is not defined`)
        } else {
            finalFunctions.push(stringModificationFunctions[fn].fn)
        }
    })
